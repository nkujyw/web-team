-- ==========================================
-- 来自主文件 anti_war_db_lcr.sql 的内容 (基础结构 + 战役/外交/会议数据)
-- ==========================================
...
-- 插入数据——战役battle_events

--  卢沟桥事变
INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('卢沟桥事变', '1937-07-07', '1937-07-28', 1,
        '日军借口士兵失踪挑衅并多次进攻宛平城与卢沟桥，标志着日本帝国主义发动全面侵华战争，也标志着中国全民族抗战的开端，由此开辟了世界反法西斯战争的东方主战场。',
        '北平沦陷。', 'battle');

SET @eid = LAST_INSERT_ID();
INSERT INTO battle_events (id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '具体数据不详');

-- 淞沪会战
INSERT INTO events(name,start_date,end_date,location_id,description,outcome,event_type)
VALUES ('淞沪会战', '1937-08-13', '1937-11-12', 2,
        '淞沪会战是全面抗战中规模最大、战斗最惨烈的战役。此役粉碎了日军“三月亡华”计划，迫使其侵华主力由华北转向华东，为中国赢得了战略主动与工矿内迁时间。',
        '中国军队顽强抵抗三个月后撤退。', 'battle');
SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events(id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '中国军队伤亡约25万，日本军队伤亡约4万');

-- 南京保卫战
INSERT INTO events(name,start_date,end_date,location_id,description,outcome,event_type)
VALUES ('南京保卫战', '1937-12-01', '1937-12-13', 3,
        '南京为首都防御要地，淞沪会战后日军大举西进，中国军队在唐生智指挥下以11万兵力苦守南京，但在日军三路合围和猛烈攻势下城防相继失守，
         12月13日南京沦陷，随后日军制造了惨绝人寰的南京大屠杀。',
        '南京失陷', 'battle');
SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events(id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '防守部队大量伤亡');

-- 平型关大捷
INSERT INTO events(name,start_date,end_date,location_id,description,outcome,event_type)
VALUES ('平型关大捷', '1937-09-25', '1937-09-25', 13,
        '八路军伏击日军运输队，是华北战场上中国军队主动歼敌的第一个重大胜利，打破了“日军不可战胜”的神话。',
        '八路军取得战役胜利。', 'battle');

SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events(id, force1_id, force2_id, casualties)
VALUES (@eid, 6, 8, '日军1000余人被歼灭，100余辆汽车被击毁，一批辎重和武器被缴。');

-- 台儿庄战役
INSERT INTO events(name,start_date,end_date,location_id,description,outcome,event_type)
VALUES ('台儿庄战役', '1938-03-16', '1938-04-15', 14,
        '是抗日战争以来取得的最大胜利，它打击了日本侵略者的嚣张气焰，坚定了全国军民坚持抗战的信心。',
        '中国军队大捷。', 'battle');
SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events(id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '中国军队约29万人参战，日军参战人数约5万人。中方伤亡约5万余人，毙伤日军约1万余人');

-- 百团大战
INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('百团大战', '1940-08-20', '1941-1-24', 7,
        '八路军对华北日军交通线发动大规模破袭战，参战兵力达105个团，是抗日战争相持阶段八路军在华北地区发动的一次规模最大、持续时间最长的战役。',
        '沉重打击日军交通补给线。', 'battle');

SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events (id, force1_id, force2_id, casualties)
VALUES (@eid, 6, 8, '日伪军被歼灭5万余人，八路军伤亡1.7万人，中毒2万余人');

-- 太原会战
INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('太原会战', '1937-09-13', '1937-11-08', 4,
        '山西有“华北之锁钥”之称，省会太原更为战略重镇。中国军队在山西太原地区与日军展开大规模防御作战，历时近两个月。',
        '太原失守', 'battle');

SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events (id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '中方伤亡约10万人，日军伤亡约3万人');

-- 长沙会战
INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('长沙会战', '1939-09', '1942-01', 6,
        '中国军队与侵华日军在以长沙为中心的第九战区进行的三次大规模的激烈攻防战。会战重创日军有生力量，有效保卫了湖南和华南国土',
        '中国军队胜利。', 'battle');

SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events (id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '中国军队以伤亡约13.9万人的代价，共歼灭日军11万余人');

-- 湘西会战
INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('湘西会战', '1945-04-09', '1945-06-07', 6,
        '又称雪峰山会战，是中国抗日战争时期正面战场的最后一次会战。湘西会战的反攻，拉开了中国军队战略总反攻的序幕，抗日正面战场由防御转入反攻阶段',
        '中国军队胜利。', 'battle');

SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events (id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '歼敌2.8万余人');

-- 衡阳保卫战
INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('衡阳保卫战', '1944-06-23', '1944-08-08', 11,
        '是中国抗战史上敌我双方伤亡最多、中国军队正面交战时间最长的城市攻防战，被誉为“东方的莫斯科保卫战”。衡阳保卫战历时长达48昼夜，以守军弹尽援绝、伤亡殆尽而惨烈告终。中国军队以少战多重创日本军。 ',
        '衡阳失守', 'battle');

SET @eid = LAST_INSERT_ID();

INSERT INTO battle_events (id, force1_id, force2_id, casualties)
VALUES (@eid, 5, 8, '日军死亡约2万人，伤近6万人
我方守军牺牲1万6千余众，最后仅存1200余人');

-- 昆仑关战役
INSERT INTO events 
(name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('昆仑关战役','1939-12','1940-02',
    15,'1939年12月，中国军队为阻止日军继续南进，在广西昆仑关地区与日军展开激烈攻坚战。国军经过多日鏖战，成功攻克昆仑关，是国民党正面战场自武汉失守以来取得的一次重大胜利。',
    '中国军队成功夺取昆仑关。','battle'
);
...
SET @eid = LAST_INSERT_ID();
INSERT INTO battle_events (id, force1_id, force2_id, casualties)
VALUES (@eid,5,8,'中方牺牲14000余人，日方伤亡5000余人'
);




-- 插入数据——会议meeting_events

INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('第一次国共重庆会谈','1937-09-20','1937-09-21',9,
'国共双方在重庆进行合作谈判，确认共同抗日大政方针。','正式形成第二次国共合作。','meeting');
SET @eid = LAST_INSERT_ID();
INSERT INTO meeting_events VALUES (@eid,'1937-09-20','周恩来、张治中等','确认抗日合作内容');


INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('中共七大','1945-04-23','1945-06-11',8,
'中国共产党第七次全国代表大会，总结抗战经验。',
'为抗战胜利和建国奠定政治基础。','meeting');
SET @eid = LAST_INSERT_ID();
INSERT INTO meeting_events VALUES (@eid,'1945-04-23','中共代表大会','抗战经验总结与未来方针');


INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('洛川会议', '1937-08-22', '1937-08-25', 8,
        '中共中央召开洛川会议，制定全面抗战路线。',
        '确立抗日民族统一战线策略。', 'meeting');
SET @eid = LAST_INSERT_ID();
INSERT INTO meeting_events (id, meeting_date, attendees, agenda)
VALUES (@eid, '1937-08-22', '中共中央领导', '制定全面抗战路线');


INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('庐山谈话会','1937-07-09','1937-07-11',5,
'蒋介石号召全国准备全面抗战。','全民抗战意识加强。','meeting');
SET @eid = LAST_INSERT_ID();
INSERT INTO meeting_events VALUES (@eid,'1937-07-09','国民政府高层','全国抗战动员');


INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('西安事变善后会议','1936-12-25','1936-12-31',9,
'国共双方就和平解决西安事变进行谈判。','推动抗日民族统一战线正式形成。','meeting');
SET @eid = LAST_INSERT_ID();
INSERT INTO meeting_events VALUES (@eid,'1936-12-25','国共代表','和平解决西安事变');


INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('开罗会议','1943-11-22','1943-11-26',16,
'中美英三国讨论对日战争目标，提出日本归还侵占领土。','发布《开罗宣言》。','meeting');
SET @eid = LAST_INSERT_ID();
INSERT INTO meeting_events VALUES (@eid,'1943-11-22','蒋介石、罗斯福、丘吉尔','对日作战与战后安排');

INSERT INTO events (name, start_date, end_date, location_id, description, outcome, event_type)
VALUES ('波茨坦公告制定会议','1945-07-17','1945-07-26',17,
'美英中三国发布波茨坦公告，要求日本无条件投降。','日本投降条件明确化。','meeting');
SET @eid = LAST_INSERT_ID();
INSERT INTO meeting_events VALUES (@eid,'1945-07-17','美英中三国代表','对日无条件投降要求');

-- 插入数据——外交diplomatic_events

INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type)
VALUES ('中苏互不侵犯条约','1937-08-21','1937-08-21',18,
'中国与苏联签署互不侵犯条约，奠定军事援助基础。',
'苏联开始向中国提供军事援助。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events (id, related_force_ids)
VALUES (@eid,'中国、苏联');


INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type)
VALUES
('中美合作修建滇缅公路','1938-11-01','1938-11-01',19,
'中国与美国合作建设滇缅公路保障国际援华物资运输。',
'加强战略运输能力。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、美国');


INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type)
VALUES
('中国参与远东国际军事法庭筹备','1945-11-01','1945-11-30',20,
'中国参与制定东京审判国际司法框架。',
'为追究日本战犯奠定法律基础。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、日本等多国');

INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type)
VALUES
('外国记者揭露南京大屠杀','1937-12-15','1938-02-01',3,
'多国记者记录日军暴行并向外传播。',
'国际社会对日本侵略的谴责增强。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、多国记者');

INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type) 
VALUES
('国际红十字援华行动','1938-03-01','1945-08-01',2,
'国际红十字会提供大量医疗设备与物资援助中国抗战。',
'改善战区医疗条件。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、国际红十字会');

INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type) 
VALUES
('宋美龄赴美演讲','1943-02-04','1943-02-28',19,
'宋美龄赴美国国会发表著名演讲，极大推动美国援华。',
'美国民意转向全面支持中国。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、美国');
...
INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type) 
VALUES
('中菲抗日合作会谈','1940-05-01','1940-05-01',21,
'中国与菲律宾民族力量建立合作，协调情报与物资。',
'东南亚地区反日合作增强。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、菲律宾');


INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type) 
VALUES
('中印反殖民与反日合作','1942-02-01','1942-02-01',22,
'中国与印度民族运动组织合作反对帝国主义扩张。',
'促进亚洲反侵略统一阵线。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、印度');

INSERT INTO events (name,start_date,end_date,location_id,description,outcome,event_type) 
VALUES
('中美平等新约签订','1943-01-11','1943-01-11',19,
'中美废除不平等条约，建立平等外交关系。',
'提升中国国际地位。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国、美国');
...
INSERT INTO events  (name,start_date,end_date,location_id,description,outcome,event_type) 
VALUES
('中国签署联合国宪章','1945-06-26','1945-06-26',23,
'中国作为战胜国之一正式签署联合国宪章。',
'确立中国世界大国地位。','diplomatic');
SET @eid = LAST_INSERT_ID();
INSERT INTO diplomatic_events VALUES (@eid,'中国');
...
-- ==========================================
-- 来自补充文件 anti_war_db_cfh.sql 的内容 (队伍 + 纪念活动/作品)
-- ==========================================

INSERT INTO `mem_activities` (`id`, `name`, `activity_date`, `location_id`, `organizer`, `description`, `photo_url`) VALUES
(1, '南京大屠杀死难者国家公祭日仪式', '2023-12-13', 3, '中共中央、国务院', '在侵华日军南京大屠杀遇难同胞纪念馆举行的国家公祭仪式，中共中央、全国人大常委会、国务院、全国政协、中央军委负责同志出席，南京全城鸣笛致哀，社会各界代表3000余人参加，缅怀30万死难同胞。', 'http://pic.people.com.cn/n1/2024/1213/c1016-40381657.html'),
(2, '中国人民抗日战争胜利78周年纪念大会', '2023-09-03', 1, '中国人民抗日战争纪念馆', '在卢沟桥畔中国人民抗日战争纪念馆举行的胜利日纪念活动，抗战老战士、英烈亲属、青少年学生等各界代表参加。活动包括向英烈敬献花篮、参观主题展览、抗战历史讲座等内容。', 'https://www.gov.cn/yaowen/tupian/202509/content_7039002.htm'),
(3, '“永不磨灭的记忆”抗战文物巡回展', '2023-07-07', 1, '国家博物馆', '纪念七七事变86周年特别展览，展出抗战文物500余件，包括武器装备、历史文献、照片、书信等珍贵实物。展览在北京首展后，将赴上海、重庆、西安等十余个城市巡回展出。', 'https://yangbo.cctv.com/2025/08/11/ARTIydMln273DGOt5S7UwvhP250811.shtml'),
(4, '滇西抗战纪念馆开馆仪式', '2023-08-15', 10, '云南省政府', '在云南腾冲滇西抗战纪念馆新馆举行的开馆仪式，原中国远征军老兵及亲属、专家学者、当地群众等千余人参加。新馆展出文物1200余件，全景展现滇西抗战历史。', 'https://www.news.cn/politics/20250815/ffb0baef9a0942f192be354ac90c98c5/c.html'),
(5, '抗战老兵口述历史采集活动', '2023-10-25', 9, '重庆抗战遗址博物馆', '组织志愿者团队采访在渝抗战老兵，以视频、音频、文字形式记录老兵抗战经历。已采访老兵37位，累计录制口述历史视频500余小时，整理文字资料30万字。', 'https://www.saac.gov.cn/daj/c100247/202511/c953736599124c8391476126adab093f.shtml'),
(6, '“重走抗战路”青少年夏令营', '2023-07-20', 8, '共青团中央', '组织全国100名优秀中学生参加的重走抗战路主题夏令营，行程涵盖延安、太行山、沂蒙山等抗战根据地。同学们通过实地参观、体验教学、与老区群众交流等形式学习抗战历史。', 'https://www.toutiao.com/article/7531239621934465577/'),
(7, '抗战经典电影公益展映月', '2023-08-01', 2, '上海市电影局', '在全市30家影院举行为期一个月的抗战电影公益展映，放映《地道战》《地雷战》《血战台儿庄》《南京！南京！》等经典影片50余场，观众可免费领取观影票。', 'https://xh.xhby.net/pc/con/202507/21/content_1468085.html'),
(8, '日本细菌战受害诉讼声援集会', '2023-09-18', 12, '侵华日军第七三一部队罪证陈列馆', '在九一八事变纪念日举行的声援集会，支持细菌战受害者对日诉讼。集会上公布了新发现的731部队档案资料，专家学者、受害者家属、市民代表等发表讲话。', 'https://www.krzzjn.com/show-1913-19195.html');
INSERT INTO `mem_works` (`id`, `name`, `type`, `author`, `create_date`, `description`, `url`, `related_event_id`, `related_character_id`) VALUES
(2, '《黄河大合唱》', '音乐作品', '冼星海', '1939-03-31', '人民音乐家冼星海创作的《黄河大合唱》原始手稿，包含《黄河船夫曲》《黄河颂》《黄河怨》等八个乐章。作品以黄河为背景，热情歌颂中华民族源远流长的光荣历史和中国人民坚强不屈的斗争精神。', 'https://music.163.com/#/album?id=39258', NULL, NULL),
(3, '《义勇军进行曲》', '音频', '聂耳', '1935-05-01', '由田汉作词、聂耳作曲的《义勇军进行曲》最早录音版本。这首歌曲在抗战期间传唱大江南北，极大鼓舞了全国军民的抗战士气，后被定为中华人民共和国国歌。', 'https://music.163.com/#/song?id=395749', NULL, NULL),
(4, '平型关大捷油画', '绘画', '孙浩', '2009-07-23', '孙浩创作的《平型关大捷》大型油画，生动描绘了八路军115师在平型关伏击日军板垣师团的壮观场面。画面气势恢宏，人物刻画生动，充分展现了中国军队的英勇顽强。', 'https://baike.baidu.com/item/%E5%B9%B3%E5%9E%8B%E5%85%B3%E5%A4%A7%E6%8D%B7/24124226', NULL, NULL),
(5, '《八佰》', '影视', '管虎', '2020-08-21', '以淞沪会战四行仓库保卫战为背景的电影，讲述“八百壮士”坚守四行仓库、阻击日军的故事。影片真实再现了中国军人视死如归的英勇精神，获得巨大社会反响。', 'https://v.qq.com/x/cover/9f8tpq2gly9p5ts/r0034rmwzpe.html', NULL, NULL),
(6, '南京大屠杀纪念馆雕塑', '雕塑', '吴为山', '2007-12-13', '设立在侵华日军南京大屠杀遇难同胞纪念馆前的主题雕塑《家破人亡》。雕塑高12.13米，寓意南京大屠杀开始日期，表现一位悲痛欲绝的母亲抱着死去的孩子仰天呼号，具有强烈的艺术感染力。', 'https://www.chnmuseum.cn/zl/zlhg/201812/t20181220_32390.shtml', NULL, NULL),
(7, '《铁道游击队》', '绘画', '丁斌曾', '1954-01-01', '描绘鲁南铁道游击队抗战斗争的经典连环画，共200余幅。生动再现了铁道游击队在铁路线上机智勇敢打击日军的传奇故事，是几代中国人的集体记忆。', 'https://www.bilibili.com/video/BV1ybG4zhEtj/', NULL, NULL),
(8, '抗战木刻版画集', '版画', '古元', '1942-08-01', '延安木刻艺术家古元创作的抗战主题木刻版画系列，包括《人民的刘志丹》《减租会》等作品。这些版画在物资匮乏的延安创作，用艺术形式记录和宣传抗战，极具历史价值。', 'http://www.360doc.com/content/22/0722/13/69380901_1040845237.shtml', NULL, NULL),
(9, '滇缅公路修建纪录片', '影视', '中央电影摄影厂', '1942-05-01', '记录20万云南各族民众修建滇缅公路的珍贵纪录片。在缺乏机械设备的条件下，人们用双手在崇山峻岭中开辟出这条“抗战生命线”，影片展现了中国人民的坚韧和智慧。', 'http://www.ynda.yn.gov.cn/html/2025/shiliaoyanjiu_0930/1006988.html', NULL, NULL),
(10, '《论持久战》', '文章', '毛泽东', '1938-05-01', '毛泽东在延安抗日战争研究会上的演讲稿首版本，系统阐述了持久战战略思想，科学预见了抗战将经历战略防御、战略相持、战略反攻三个阶段，对指导全国抗战产生了深远影响。', 'https://www.toutiao.com/article/7143229337708626462/', NULL, NULL);
-- 修复后的 teams 数据：将无效的 leader_id 0 改为了 NULL
...
INSERT INTO `question` (`content`, `option_a`, `option_b`, `option_c`, `option_d`, `correct_answer`, `related_event_id`, `related_character_id`) VALUES
('标志着中国全民族抗战开始的历史事件是？', '九一八事变', '七七事变（卢沟桥事变）', '西安事变', '八一三事变', 'B', 1, NULL),

('打破了日军“不可战胜”神话，是抗战以来中国军队取得的第一个重大胜利的战役是？', '台儿庄大捷', '昆仑关大捷', '平型关大捷', '百团大战', 'C', 4, 4),

('粉碎了日军“三个月灭亡中国”的企图，为中国民族工业内迁赢得时间的战役是？', '淞沪会战', '太原会战', '徐州会战', '武汉会战', 'A', 2, 1),

('百团大战是抗日战争相持阶段八路军在华北地区发动的一次规模最大、持续时间最长的战役，其主要指挥官是？', '朱德', '毛泽东', '刘伯承', '彭德怀', 'D', 6, 9),

('1943年11月，中美英三国首脑在埃及举行会议，发表了什么文件要求日本归还窃取的中国领土？', '《波茨坦公告》', '《大西洋宪章》', '《开罗宣言》', '《联合国家宣言》', 'C', 17, 1),

('在枣宜会战中壮烈殉国，被周恩来称为“全国军人楷模”的国民党高级将领是？', '佟麟阁', '赵登禹', '张自忠', '戴安澜', 'C', NULL, 4),

('抗战期间，毛泽东撰写的哪篇著作系统阐述了持久战的战略思想？', '《论持久战》', '《论联合政府》', '《中国革命和中国共产党》', '《新民主主义论》', 'A', NULL, 7),

('被称为“东方的莫斯科保卫战”，中国军队坚守48天，重创日军的城市攻防战是？', '长沙保卫战', '常德会战', '衡阳保卫战', '武汉会战', 'C', 10, 3),

('指挥三次长沙会战，创造“天炉战法”歼灭大量日军的中国将领是？', '孙立人', '薛岳', '白崇禧', '卫立煌', 'B', 8, 6),

('日本天皇宣布无条件投降的日期是？', '1945年8月15日', '1945年9月2日', '1945年9月3日', '1945年9月9日', 'A', NULL, 13);



INSERT INTO `messages` (`message`) VALUES
('铭记历史，吾辈自强！向抗战英雄致敬！'),
('珍爱和平，远离战争。今天的幸福生活来之不易。'),
('历史是最好的教科书，也是最好的清醒剂。'),
('一寸山河一寸血，十万青年十万军。致敬先烈！'),
('勿忘国耻，振兴中华！'),
('看着这些历史资料，眼眶湿润了，伟大的中国人民万岁！');